...
def task_openset(model,generic_vp1, generic_vp2, generic_vp3, generic_vp4,
    ...
    nms_boxes, masks, ious, ori_masks, scores_per_image_openset = model.model.evaluate_demo_content_openset_multi_with_content_features(
    ...
    # 遍历每个 box，画上去
    image_tgt_w,image_tgt_h = image_ori.size
    for box in nms_boxes:
        demo = visual.draw_box(box.tolist(), edge_color="g", alpha=0.6, image_size=(image_tgt_w,image_tgt_h))
